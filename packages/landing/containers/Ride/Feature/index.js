...
import { Features } from 'common/src/data/Ride';
  ...
  return (
    <FeatureSectionWrapper id="feature_section">
      <Container noGutter mobileGutter width="1200px" className="container">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="Sin tarifas dinámicas" />
          <Text
            {...secDescription}
            content="Envía hasta 2 paquetes por precio base"
          />
        </Box>
        ...
        <Box {...secTitleWrapper}>
          ...
          <Text
            {...secDescription}
            content="*$12 por paquete adicional en cualquier modalidad"
          />
        </Box>
      </Container>
