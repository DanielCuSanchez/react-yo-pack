      ...
      <Container noGutter mobileGutter width="1200px" className="container">
        <Box {...row}>
          <Box {...contentArea} className="contentArea">
            <Heading
              content="Entregas en menos 90 minutos"
              {...greetingStyle}
            />
            <Heading content="desde $49" {...greetingStyleTwo} />
            <EmailInputWrapper>
              {/* <Input
                inputType="email"
              ...
              <Link href="https://vigorous-heyrovsky-e32014.netlify.com/">
                <a>
                  <Button title="Solicita recolección" {...button} />
                </a>
              </Link>
            </EmailInputWrapper>
            <Text
          ...
          {/* <Box {...imageArea} className="image_area">
            ...
            <Image src={ManImage} className="car_image_area" alt="Car Image" />
          </Box> */}
        </Box>
      </Container>
    </BannerWrapper>
...
BannerSection.defaultProps = {
  ...
  greetingStyleTwo: {
    as: 'h1',
    color: '#CE902A',
    fontSize: ['20px', '26px', '18px', '30px', '40px'],
    fontWeight: '400',
    fontFamily: 'Poppins',
